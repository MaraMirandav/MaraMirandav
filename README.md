...
|---|---|---|---|
| **Cajero ATM (CLI)** | Aplicación de terminal que simula operaciones bancarias, implementando el patrón DAO y transacciones SQL. | `Java`, `Python`, `JDBC`, `MySQL` | `[Ver Repositorio]`|
